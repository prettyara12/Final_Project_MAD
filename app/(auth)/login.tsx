      ...
      <KeyboardAvoidingView style={styles.keyboardView} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Masuk untuk melanjutkan perjalanan belajarmu dengan AI.</Text>
          </View>
             ...
             <View style={styles.formContainer}>
               ...
               <View style={styles.mainButtonContainer}>
                 {isLoading ? (
                    ...
                    <CustomButton title="Masuk Sekarang" onPress={handleLogin} style={styles.loginBtnStyle} />
                 )}
               </View>
               ...
               <View style={styles.socialButtonsRow}>
                 <TouchableOpacity style={styles.socialBtn}><Ionicons name="logo-google" size={24} color="#EA4335" /></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  registerContainer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 'auto' },
